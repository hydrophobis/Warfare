      ...
      public static void load(){
        ...
        warfareFactory = new UnitFactory("ground-factory"){{
            ...
            plans = Seq.with(
                ...
                new UnitPlan(WarfareUnitTypes.repairCenter, 0f * 10, with(Items.silicon, 8, Items.coal, 0)),
                new UnitPlan(WarfareUnitTypes.repairOutpost, 0f * 10, with(Items.silicon, 0, Items.lead, 0, Items.titanium, 0)),
                new UnitPlan(WarfareUnitTypes.fieldCenter, 0f * 10, with(Items.silicon, 0, Items.lead, 0)),
                new UnitPlan(WarfareUnitTypes.repairCamp, 0f * 10, with(Items.silicon, 0, Items.lead, 0)),
